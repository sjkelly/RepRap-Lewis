...
module electronics_assembly()
{
  translate(-electronics_holes[3]/2 + [0,-foot_length/4-foot_thick,0])union()
  {
    ...
    electronics_mount_l();
    electronics_mount_r();
    translate(electronics_holes[3]/2+[0,-foot_length/4+foot_thick,electronics_thick+washer_thick])rotate([180,0,0])cap_screw(screw,electronics_thick+washer_thick+foot_thick*2);
    translate(electronics_holes[3]/2+[0,foot_length/4+foot_thick,electronics_thick+washer_thick])rotate([180,0,0])cap_screw(screw,electronics_thick+washer_thick+foot_thick*2);
    translate(electronics_holes[3]/2+[0,-foot_length/4+foot_thick,electronics_thick+washer_thick])rotate([180,0,0])flat_washer(screw);
    translate(electronics_holes[3]/2+[0,foot_length/4+foot_thick,electronics_thick+washer_thick])rotate([180,0,0])flat_washer(screw);
  }
}
