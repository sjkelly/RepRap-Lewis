...
module truss_assembly(){
	union(){
		...
		translate([truss_length-motor_length-truss_top_thick/2,truss_width/2+motor_hole_spacing/2-screw_diameter,truss_height*2/3])washer();
		translate([truss_length-motor_length-truss_top_thick/2,truss_width/2-motor_hole_spacing/2+screw_diameter,truss_height*2/3])washer();
		translate([truss_length-motor_length-truss_top_thick/2,truss_width/2+motor_hole_spacing/2-screw_diameter,truss_height*2/3+washer_thick])rotate([180,0,0])screw(truss_height*2/3+washer_thick+motor_width/2-motor_hole_spacing/2+washer_diameter/2+lock_nut_height);
		translate([truss_length-motor_length-truss_top_thick/2,truss_width/2-motor_hole_spacing/2+screw_diameter,truss_height*2/3+washer_thick])rotate([180,0,0])screw(truss_height*2/3+washer_thick+motor_width/2-motor_hole_spacing/2+washer_diameter/2+lock_nut_height);
	}
}
