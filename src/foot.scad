...
module extruder_foot_assembly(){
	...
	translate([e0motor_width/2/sin(45),e0motor_width/2/sin(45),foot_thick])rotate([-90,30,45])translate([-e0motor_width/2,-e0motor_width/2,-e0motor_length-extruder_thick])translate([e0motor_hole_spacing/2,e0motor_hole_spacing/2,e0motor_length+extruder_thick/2+washer_thick])rotate([0,180,0])screw(extruder_thick/2+washer_thick+e0motor_hole_engagement);
		translate([e0motor_width/2/sin(45),e0motor_width/2/sin(45),foot_thick])rotate([-90,30,45])translate([-e0motor_width/2,-e0motor_width/2,-e0motor_length-extruder_thick])translate([e0motor_hole_spacing/2,e0motor_hole_spacing/2,e0motor_length+extruder_thick/2])washer();
