...
module sweep_link_assembly()
{
  ...
  union()
  {
    ...
    translate([sweep_link_length,0,motor_length])rotate([180,0,0])stepper(motor);
    translate([sweep_link_length+motor_hole_spacing/2,motor_hole_spacing/2,-sweep_link_thick-washer_thick])flat_washer(screw);
    translate([sweep_link_length+motor_hole_spacing/2,-motor_hole_spacing/2,-sweep_link_thick-washer_thick])flat_washer(screw);
    translate([sweep_link_length-motor_hole_spacing/2,motor_hole_spacing/2,-sweep_link_thick-washer_thick])flat_washer(screw);
    translate([sweep_link_length-motor_hole_spacing/2,-motor_hole_spacing/2,-sweep_link_thick-washer_thick])flat_washer(screw);
    translate([sweep_link_length+motor_hole_spacing/2,motor_hole_spacing/2,-washer_thick-sweep_link_thick])cap_screw(screw,sweep_link_thick+motor_hole_engagement+washer_thick);
    translate([sweep_link_length+motor_hole_spacing/2,-motor_hole_spacing/2,-washer_thick-sweep_link_thick])cap_screw(screw,sweep_link_thick+motor_hole_engagement+washer_thick);
    translate([sweep_link_length-motor_hole_spacing/2,motor_hole_spacing/2,-washer_thick-sweep_link_thick])cap_screw(screw,sweep_link_thick+motor_hole_engagement+washer_thick);
    translate([sweep_link_length-motor_hole_spacing/2,-motor_hole_spacing/2,-washer_thick-sweep_link_thick])cap_screw(screw,sweep_link_thick+motor_hole_engagement+washer_thick);
