...
module sweep_link_assembly(){
	translate([0,0,motor_shaft_length])rotate([0,0,360*$t])union(){
		rotate([180,0,0])sweep_link();
		translate([sweep_link_length,0,-motor_length-sweep_link_thick])motor();
		translate([sweep_link_length+motor_hole_spacing/2,motor_hole_spacing/2,0])washer();
		translate([sweep_link_length+motor_hole_spacing/2,-motor_hole_spacing/2,0])washer();
		translate([sweep_link_length-motor_hole_spacing/2,motor_hole_spacing/2,0])washer();
		translate([sweep_link_length-motor_hole_spacing/2,-motor_hole_spacing/2,0])washer();
		translate([sweep_link_length+motor_hole_spacing/2,motor_hole_spacing/2,washer_thick])rotate([180,0,0])screw(sweep_link_thick+motor_hole_engagement+washer_thick);
		translate([sweep_link_length+motor_hole_spacing/2,-motor_hole_spacing/2,washer_thick])rotate([180,0,0])screw(sweep_link_thick+motor_hole_engagement+washer_thick);
		translate([sweep_link_length-motor_hole_spacing/2,motor_hole_spacing/2,washer_thick])rotate([180,0,0])screw(sweep_link_thick+motor_hole_engagement+washer_thick);
		translate([sweep_link_length-motor_hole_spacing/2,-motor_hole_spacing/2,washer_thick])rotate([180,0,0])screw(sweep_link_thick+motor_hole_engagement+washer_thick);
